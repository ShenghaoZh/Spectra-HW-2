...
//NO.56 Merge Intervals
                                                    ...
                                                    // merge or push, then move the digit forward.
/**
...
//NO.456 132-Pattern
                                                    // 思路：定位每一个上升区间，然后for搜寻区间后是否存在k值满足条件
...
function dfs(node, res){
    if(!Array.isArray(node)){
        ...
        for(let item of node) dfs(item, res);
    }
}
